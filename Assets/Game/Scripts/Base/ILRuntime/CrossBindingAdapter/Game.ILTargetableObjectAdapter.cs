...
namespace Game
{   
    public class ILTargetableObjectAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(Game.ILTargetableObject);
            }
        }
        ...
        public class Adapter : Game.ILTargetableObject, CrossBindingAdaptorType
        {
            ...
            {
                if (mOnTriggerEnter_10.CheckShouldInvokeBase(this.instance))
                    base.OnTriggerEnter(other);
                else
                    mOnTriggerEnter_10.Invoke(this.instance, other);
            }

            protected override void OnTriggerExit(UnityEngine.Collider other)
            {
                if (mOnTriggerExit_11.CheckShouldInvokeBase(this.instance))
