...
{
    unsafe class Game_ILForm_Binding
    {
        ...
        static StackObject* get_ReferenceCollector_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.ILForm instance_of_this_method = (Game.ILForm)typeof(Game.ILForm).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
