...
{
    unsafe class Game_SoundExtension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.SoundExtension);
            args = new Type[]{typeof(UnityGameFramework.Runtime.SoundComponent), typeof(System.Int32), typeof(Game.Entity), typeof(System.Object)};
        ...
        static StackObject* PlaySound_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Entity @bindingEntity = (Game.Entity)typeof(Game.Entity).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = Game.SoundExtension.PlaySound(@soundComponent, @soundId, @bindingEntity, @userData);
        ...
        static StackObject* PlayMusic_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Game.SoundExtension.PlayMusic(@soundComponent, @musicId, @userData);
