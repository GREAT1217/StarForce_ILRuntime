...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            Game_Entity_Binding.Register(app);
            ...
            Game_AircraftData_Binding.Register(app);
            Game_EntityExtension_Binding.Register(app);
            System_Collections_Generic_List_1_WeaponData_Binding.Register(app);
            System_Collections_Generic_List_1_ArmorData_Binding.Register(app);
            System_Collections_Generic_List_1_Weapon_Binding.Register(app);
            System_Collections_Generic_List_1_Armor_Binding.Register(app);
            Game_EffectData_Binding.Register(app);
            UnityEngine_Transform_Binding.Register(app);
            Game_EntityData_Binding.Register(app);
            Game_SoundExtension_Binding.Register(app);
            Game_TargetableObjectData_Binding.Register(app);
            Game_ImpactData_Binding.Register(app);
            UnityEngine_Vector3_Binding.Register(app);
            Game_Weapon_Binding.Register(app);
            ...
            Game_TargetableObject_Binding.Register(app);
