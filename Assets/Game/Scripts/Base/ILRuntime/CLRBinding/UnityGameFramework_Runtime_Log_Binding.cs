...
{
    unsafe class UnityGameFramework_Runtime_Log_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityGameFramework.Runtime.Log);
            ...
            args = new Type[]{typeof(System.String)};
            if (genericMethods.TryGetValue("Warning", out lst))
            {
            ...
            args = new Type[]{typeof(System.String)};
            if (genericMethods.TryGetValue("Info", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.String), typeof(System.String)))
            ...
            if (genericMethods.TryGetValue("Error", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.String), typeof(System.String), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            if (genericMethods.TryGetValue("Info", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.String), typeof(System.String), typeof(System.String), typeof(System.String), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, Info_6);
        ...
        static StackObject* Warning_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.Log.Warning<System.String>(@format, @arg);
        ...
        static StackObject* Info_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.Log.Info<System.String>(@format, @arg);
        ...
        static StackObject* Error_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.Log.Error<System.String, System.String>(@format, @arg1, @arg2);
        ...
        static StackObject* Info_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.Log.Info<System.String, System.String>(@format, @arg1, @arg2);

            return __ret;
        }

        static StackObject* Info_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.String @arg4 = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
            ...
            UnityGameFramework.Runtime.Log.Info<System.String, System.String, System.String, System.String>(@format, @arg1, @arg2, @arg3, @arg4);
