    ...
    unsafe class UnityGameFramework_Runtime_DataTableComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("GetDataTable", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(GameFramework.DataTable.IDataTable<Game.DREntity>)))
                    {
            ...
            if (genericMethods.TryGetValue("GetDataTable", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(GameFramework.DataTable.IDataTable<Game.DRScene>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* GetDataTable_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.DataTableComponent instance_of_this_method = (UnityGameFramework.Runtime.DataTableComponent)typeof(UnityGameFramework.Runtime.DataTableComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = instance_of_this_method.GetDataTable<Game.DREntity>();
        ...
        static StackObject* GetDataTable_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetDataTable<Game.DRScene>();
