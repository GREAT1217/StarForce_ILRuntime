...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityGameFramework_Runtime_EntityComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ShowEntity_0);
            args = new Type[]{};
            method = type.GetMethod("HideAllLoadingEntities", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, HideAllLoadingEntities_1);
            args = new Type[]{};
            method = type.GetMethod("HideAllLoadedEntities", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, HideAllLoadedEntities_2);


        }


        static StackObject* ShowEntity_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* HideAllLoadingEntities_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* HideAllLoadedEntities_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
